...
if ($_SESSION['login'] && $_SESSION['login'] != 'admin') {
    header("location:../view/homeauser.php");
}
?> 
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="khuyenmai_contemt">
                ...
                ?>
                    <div id="the" class="card">
                        ...
                        <p style="text-align: center;"><a href="../Controller/xoa.php?this_id=<?php echo $row['id']?>" class="btn btn-primary"
                                style="border-radius: 20px; width:130px; padding-left: 25px;padding-right: 25px;background-color: #BF98A0;">
                                XÓA</a>
                        </p>
                    </div>
